...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference("Prescription.count") do
      post prescriptions_url, params: { prescription: { appointment_id: @prescription.appointment_id, doctor_id: @prescription.doctor_id, patient_id: @prescription.patient_id, prescription: @prescription.prescription } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { appointment_id: @prescription.appointment_id, doctor_id: @prescription.doctor_id, patient_id: @prescription.patient_id, prescription: @prescription.prescription } }
